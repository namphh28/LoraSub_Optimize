...
from models.vit_lora import VisionTransformer, PatchEmbed, Block, resolve_pretrained_cfg, build_model_with_cfg, \
...
class ViT_lora_co(VisionTransformer):
    ...
    def forward(self, x, task_id, register_blk=-1, get_feat=False, get_cur_feat=False, get_cur_x=False):
        ...
        for i, blk in enumerate(self.blocks):
            x = blk(x, task_id, register_blk == i, get_feat=get_feat, get_cur_feat=get_cur_feat,get_cur_x=get_cur_x)
